...
weekly_earnings = st.number_input("Ganhos Semanais (€)", min_value=0.0, value=670.0, step=10.0)
weekly_hours = st.number_input("Horas Semanais", min_value=0, value=48, step=1)
