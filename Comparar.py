...
weekly_earnings = st.number_input("Ganhos Semanais (€)", min_value=0.0, value=500.0, step=10.0)
weekly_hours = st.number_input("Horas Semanais", min_value=0, value=50, step=1)
fuel_cost = st.number_input("Combustível (€)", min_value=0.0, value=150.0, step=5.0)
